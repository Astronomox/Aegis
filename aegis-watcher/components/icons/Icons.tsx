// Hand-built SVG icon set. No emoji anywhere in the UI, no external icon
// dependency needed. All icons are 20x20 stroke-based, currentColor by
// default so they inherit whatever text color wraps them.
